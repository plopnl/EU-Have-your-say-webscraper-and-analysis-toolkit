...
DUP_FILE = ATTACHMENT_DUP_FILE
FEEDBACK_FILE = FEEDBACK_WITH_LENGTHS
OUT_TOPN = ATTACHMENT_SIMILARITY_TOPN
OUT_COMBINED = ATTACHMENT_COMBINED_TOPN
OUT_AUG = SIMILARITY_WITH_ATTACHMENTS
